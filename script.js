// Starter Kit: пустые функции-обработчики с подсказками для студентов

// Задание 1: Калькулятор ИМТ
function handleBMI() {
  // Получить значения веса и роста
  // Проверить валидность
  // Рассчитать ИМТ
  // Вывести результат в #bmiResult
...
function handleKgToLbs() {
  ...
  // Проверить валидность
  // Конвертировать в фунты
  // Вывести результат в #weightResult
...
function handleCmToFeet() {
  ...
  // Вывести результат в #heightResult
  console.log("handleCmToFeet вызвана");
}

function handleFeetToCm() {
  // Получить футы и дюймы
  // Проверить валидность
  // Конвертировать в см
  // Вывести результат в #heightResult2
